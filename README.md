...
2. [Function](#2-functions)\
        2.1.[sprintf Specifiers](#21-sprintf-specifiers)\
        2.2.[sprintf Flags](#22-sprintf-flags)\
        2.3.[sprintf Width Description](#23-sprintf-width-description)\
        2.4.[sprintf Precision Description](#24-sprintf-precision-description)\
        2.5.[sprintf Length Description](#25-sprintf-length-description)\
        2.6.[Special string processing functions (from the String class in C#)](#26-special-string-processing-functions-from-the-string-class-in-c)
3. [Goal](#3-goal)
4. [Build](#4-build)


## 1. Information
In this project, I will develop my own implementation of the string.h library 
in the C programming language with some additions (with your own implementation of the sprintf functions). 
...
### 2.4. sprintf Precision Description
